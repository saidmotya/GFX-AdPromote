...
public final class PromoteInterstitialAdvanceBinding implements ViewBinding {
  @NonNull
  ...
  private PromoteInterstitialAdvanceBinding(@NonNull RelativeLayout rootView, @NonNull TextView ad,
      ...
      @NonNull LinearLayout info, @NonNull RelativeLayout interIconProgress,
      @NonNull ImageView interIcons, @NonNull TextView interstitialAppName,
      @NonNull RelativeLayout interstitialClose, @NonNull RelativeLayout interstitialInstall,
      @NonNull TextView interstitialInstallTxt, @NonNull ImageView interstitialPreview,
      @NonNull RelativeLayout interstitialPreviewProgress,
  ...
  @NonNull
  public static PromoteInterstitialAdvanceBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PromoteInterstitialAdvanceBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.promote_interstitial_advance, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PromoteInterstitialAdvanceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PromoteInterstitialAdvanceBinding((RelativeLayout) rootView, ad, buttons,
          closeCount, closeText, dotsIndicator, downloadAd, info, interIconProgress, interIcons,
