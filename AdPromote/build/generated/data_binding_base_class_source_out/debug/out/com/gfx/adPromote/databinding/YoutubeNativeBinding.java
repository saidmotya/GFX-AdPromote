...
public final class YoutubeNativeBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout subscribeLnr;
  ...
  private YoutubeNativeBinding(@NonNull FrameLayout rootView, @NonNull TextView ad,
      @NonNull LinearLayout bodyColor, @NonNull ImageView icon, @NonNull TextView likeCounter,
      @NonNull RelativeLayout nativeIconProgress, @NonNull RelativeLayout nativePreviewProgress,
      @NonNull TextView on, @NonNull RelativeLayout playVideo, @NonNull FrameLayout promoteNative,
      @NonNull RelativeLayout relPreview, @NonNull AppCompatTextView subscribe,
      @NonNull LinearLayout subscribeLnr, @NonNull TextView title, @NonNull ImageView videoPreview,
      @NonNull TextView views, @NonNull RelativeLayout watchVideo,
      @NonNull AppCompatTextView watchVideoTxt) {
    ...
    this.subscribeLnr = subscribeLnr;
    this.title = title;
  ...
  @NonNull
  public static YoutubeNativeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static YoutubeNativeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.youtube_native, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static YoutubeNativeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.subscribeLnr;
      LinearLayout subscribeLnr = ViewBindings.findChildViewById(rootView, id);
      if (subscribeLnr == null) {
        break missingId;
      }
      ...
      return new YoutubeNativeBinding((FrameLayout) rootView, ad, bodyColor, icon, likeCounter,
          nativeIconProgress, nativePreviewProgress, on, playVideo, promoteNative, relPreview,
          subscribe, subscribeLnr, title, videoPreview, views, watchVideo, watchVideoTxt);
    }
