...
public final class PromoteInterstitialBinding implements ViewBinding {
  @NonNull
  ...
  private PromoteInterstitialBinding(@NonNull RelativeLayout rootView, @NonNull TextView ad,
  ...
  @NonNull
  public static PromoteInterstitialBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PromoteInterstitialBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.promote_interstitial, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PromoteInterstitialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PromoteInterstitialBinding((RelativeLayout) rootView, ad, buttons, closeCount,
          closeText, dotsIndicator, downloadAd, info, interIconProgress, interIcons,
