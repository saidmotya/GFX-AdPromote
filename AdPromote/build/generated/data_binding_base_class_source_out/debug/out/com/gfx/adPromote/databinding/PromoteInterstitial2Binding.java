...
public final class PromoteInterstitial2Binding implements ViewBinding {
  ...
  private PromoteInterstitial2Binding(@NonNull RelativeLayout rootView, @NonNull TextView ad,
  ...
  @NonNull
  public static PromoteInterstitial2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PromoteInterstitial2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.promote_interstitial_2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PromoteInterstitial2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PromoteInterstitial2Binding((RelativeLayout) rootView, ad, buttons, closeCount,
          closeText, dotsIndicator, downloadAd, interIconProgress, interIcons, interstitialAppName,
          interstitialClose, interstitialInstall, interstitialInstallTxt, interstitialPreview,
          interstitialPreviewProgress, interstitialShortDescription, rateAd, rateCounter,
          viewpager);
    }
